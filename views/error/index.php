...
<div id="page-container" class="fade">
    <!-- begin error -->
    <div class="error">
        <div class="error-code m-b-10 text-warning">404 <i class="fa fa-warning"></i></div>
        <div class="error-content">
            <div class="error-message">Upss, não conseguimos encontrar a página requisitada...</div>
            <div class="error-desc m-b-20">
                <b>A página que estás a procura não existe. <br />
                    Talvéz, o link a baixo irá ajudar-te a encontrar o que procuras.</b>
            </div>
            <div>
