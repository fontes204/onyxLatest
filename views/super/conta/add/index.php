                ...
                <div class="profile-section">
                    ...
                    <div class="profile-right">
                        ...
                        <div class="panel-footer">
                            <div class="pull-left f-s-14">
                                <a href="<?php echo URL?>super/visualizarUtilizador/<?php echo base64_encode($idUtilizador);?>" class="btn btn-inverse" style=" text-align: right">← Voltar</a>
                            </div>

                            <div class="pull-right f-s-14">
                                <button type="button" class="btn btn-sm btn-primary m-r-5 btn-add-conta"><i class="fa fa-save"></i> Salvar</button>
                            </div>
                        </div>
                    </div>
                    <!--                <span>&nbsp;</span>-->
