...
$user=new Utilizador();
$field=array('u.*');
$param=array(1,Session::get('administracao'));
$k=$dao->buscaExaustiva($field,'utilizador u,conta c','u._id=c._id_utilizador and c._estado=? and u._id_administracao=?',$param);
$i=0;
?>
        ...
        <div class="col-md-12 col-sm-6">
            <div class="widget widget-stats bg-blue">
                ...
                <div class="stats-info">
                    <p><i class="fa fa-list"></i> Listar Conta Activa</p>
                    <h4>&nbsp;</h4>
                </div>
            </div>
        </div>
