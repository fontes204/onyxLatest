<?php
$prov=$dao->listarTodos('provincia',"order by _nome asc")->fetchAll(2);
                        ...
                        <div id="wizard">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="numbi"  placeholder="002841878ZZ039" data-parsley-trigger="keyup" data-parsley-minlength="14" data-parsley-maxlength="14" class="form-control numbi-user" data-parsley-group="wizard-step-1" required />
                                            </div>
                                        </div>
                                        <!-- end col-4 -->
                                        <!-- begin col-4 -->
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input type="email" name="email" placeholder="onyx@example.com" class="form-control email-dominio" maxlength="46" data-parsley-group="wizard-step-3" data-parsley-type="email" />
                            ...
                            <div class="wizard-step-4">
                                <div class="jumbotron m-b-0 text-center">
                                    <p>Os campos foram preenchidos correctamente, clique no botão Salvar para finalizar o processo.</p>
                                </div>
                            </div>
                        </div>
