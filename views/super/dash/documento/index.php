    ...
    <div class="row">
        ...
        <div class="col-md-3 col-sm-6">
            <div class="widget widget-stats bg-green">
                ...
                <div class="stats-link">
                    <a href="<?php echo URL.$att->getController()?>/adcionarDocumento">Ver Detalhes <i class="fa fa-eye"></i></a>
                </div>
            </div>
        </div>
        <!-- end col-3 -->
        ...
        <div class="col-md-3 col-sm-6">
            <div class="widget widget-stats bg-blue">
                ...
                <div class="stats-link">
                    <a href="<?php echo URL.$att->getController()?>/listarDocumento">Ver Detalhes <i class="fa fa-eye"></i></a>
                </div>
            </div>
        </div>
        <!-- end col-3 -->
