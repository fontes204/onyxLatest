...
$ctrl=$entradaSaida->contaRegistro(base64_decode($att->getParam()));
...
$campo = array('*');
$param = array(base64_decode($att->getParam()), 1, Session::get('id_user'));
$parecer = $procDao->buscaExaustiva($campo, 'parecer', '_id_processo=? and _id_fase=? and _destino=?', $param)->fetchObject();//buscando o parecer
...
<div id="content" class="content">
    ...
    switch ($dadosReq->_tipo) {
        case 'cidadao':
            ...
            $campos = array('*');
            $dadosRq = $procDao->buscaExaustiva($campos, 'cidadao', '_id_requerente=?', $vl)->fetchObject();//buscando os dados do cidadao
            $pais = $procDao->listarPorId('pais', $dadosRq->_nacionalidade)->fetchObject();//buscando a nacionalidade

            $campo=array('*');
            $param=array('Tecnico','TRUC');
            $grupo=$procDao->buscaExaustiva($campo,'grupo','_perfil=? and _sigla=?',$param)->fetchObject();//buscando as funcoes

            $campo=array('*');
            $param=array($grupo->_id);
            $tecnico=$procDao->buscaExaustiva($campo,'utilizador','_id_grupo=?',$param)->fetchAll(2);//buscando as funcoes
                ...
                <div class="profile-section">
                    ...
                    <div class="profile-left">
                        ...
                        <div class="hidden-sm hidden-xs" style="width: 175px">
                            <p>
                                <?php if ($docFalta->rowCount()>0):?>
                                <a href="<?php echo URL?>secretariaGeral/continuar/<?php echo ($att->getParam())?>" class="btn btn-sm btn-primary btn-block" style="text-align: left"><i class="fa fa-edit"></i> Adicionar Documento</a>
                                <?php endif;?>
                            </p>
                        </div>
                            ...
                            <div class="table-responsivse">
                                ...
                                <table class="table table-responsive">
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo $att->idade($dadosRq->_data_nascimento); ?></td>
                                    </tr>
                                    <hr>
                                    <tr>
                                        <td>&nbsp;</td>
