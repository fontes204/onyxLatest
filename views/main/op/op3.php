<ul class="nav">
    ...
    <li class="has-sub active">
        ...
        <ul class="sub-menu">
            ...
            <li class="active"><a href="<?php echo URL?>administrador/entrada"><i class="fa fa-arrow-circle-down"></i> Entrada</a></li>
            <li><a href="<?php echo URL?>administrador/saida"><i class="fa fa-arrow-circle-up"></i> Sa&iacute;da</a></li>
        </ul>
    </li>
    <li class="has-sub">
        <a href="javascript:;">
