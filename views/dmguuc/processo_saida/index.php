...
$rs=$procDao->listarSaida(Session::get('id_user'));
$cont=0;
?>
<!-- begin #content -->
        ...
        <div class="col-md-12">
            ...
            <div class="panel panel-inverse">
                <div class="panel-heading">
                    <h4 class="panel-title">Caixa de Saída</h4>
                </div>
                <div class="panel-body">
                    <table id="data-table" class="table table-striped table-bordered">
                        ...
                        <?php foreach ($rs as $ls):
                            $cont+=1;
                            $destino=$procDao->buscarDestino(Session::get('id_user'),$ls->_id,1);
                            ?>
                            <tr class="odd gradeX">
                                <td><?php echo $cont;?></td>
                                <td class="text-center"><?php echo $ls->_num_processoGeral?></td>
                                <td class="text-center"><?php echo $ls->_assunto?></td>
                                <td class="text-center"><?php echo $ls->_nome?></td>
                                <td class="text-center"><?php echo $att->DataAo($ls->_data)?></td>
                                <td class="text-center"><?php echo $destino->_perfil?></td>
                            </tr>
                        <?php endforeach;?>
                        </tbody>
                    </table>
