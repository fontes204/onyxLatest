...
$att=new Atributo();
//$campo=array('distinct p._id as id, r._nome, p._assunto, p._num_processoGeral, pcr._data, pcr._destino');
                ...
                <div class="panel-body">
                    <table id="data-table" class="table table-striped table-bordered">
                        ...
                        <?php foreach ($rs as $ls):
                            $cont+=1;
                            $ctrlfase=$terreno->numRegisto($ls->codReq);
                            ...
                            <tr class="odd gradeX">
                                ...
                                <td class="text-center">
                                    <p>
                                        <a href="<?php echo URL?>tecnico/processo/<?php echo base64_encode($ls->_id)?>" class="btn <?php echo $btn_color?> btn-icon btn-sm"><i class="fa <?php echo $btn_fa?>"></i></a>
                                    </p>
                                </td>
                            </tr>
                        <?php endforeach;?>
