...
$dadosTerreno = $procDao->dadosTerreno($dadosReq->_id);

$dadosZona = $procDao->listarPorId('zona', $dadosTerreno->_id_zona)->fetchObject();
$comuna1 = $procDao->listarPorId('comuna', $dadosZona->_id_comuna)->fetchObject();
$bairro1 = $procDao->listarPorId('bairro', $dadosZona->_id_bairro)->fetchObject();
                ...
                <div class="profile-section">
                    ...
                    <div class="profile-left">
                        ...
                        <div class="hidden-sm hidden-xs" style="width: 175px">
                            <p>
                                <a href="#parecer-dmguuc" data-toggle="modal"
                    ...
                    <div class="profile-right">
                        ...
                        <div class="profile-info">
                            ...
                            <div class="table-responsivse" style="border-left: 1px">
                                ...
                                <div class="" style="margin-top: -6.5%">
                                    <h6 class="text-primary"><i class="fa fa-map-marker"></i> Dados do Terreno</h6>
                                    <table class="table">
                                        <thead>
                                        <tr>
                                            <th>Comuna</th>
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo $dadosTerreno->_lote ?></td>
