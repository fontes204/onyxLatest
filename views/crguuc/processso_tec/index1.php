...
$dadosTerreno=$procD->dadosTerreno($proc->_id_requerente);

$dadosZona=$procD->listarPorId('zona',$dadosTerreno->_id_zona)->fetchObject();
$comuna1=$procD->listarPorId('comuna',$dadosZona->_id_comuna)->fetchObject();
$bairro1=$procD->listarPorId('bairro',$dadosZona->_id_bairro)->fetchObject();
...
$campo = array('*');
$param = array(base64_decode($opcao[0]->getParam()), 2,Session::get('id_user'));
                ...
                <div class="col-md-8">
                    <div class="panel panel-inverse" data-sortable-id="index-6">
                                ...
                                <a href="#modal-parecer-admin"
                                   class="btn btn-xs btn-default" data-toggle="modal"><i class="fa fa-list"></i> Ver o parecer</a>&nbsp;
                                    <a href="#parecer-dmguuc" class="btn btn-xs btn-primary"
                                       data-toggle="modal"><i class="fa fa-list"></i> Adicionar Parecer</a>
                            </div>
                        ...
                        <div class="panel-body p-t-0">
                            ...
                            <fieldset style="margin-top: 1%">
                                <legend class="text-primary" style="font-size: medium">Dados do Terreno</legend>
                                <table class="table table-valign-middle m-b-0 table-striped table-bordered">
                                    <thead>
                                    <tr>
                                        <th>Comuna</th>
                                    ...
                                    <tbody>
                                    <tr>
                                        <td><?php echo $comuna1->_nome ?></td>
                                        <td><?php echo $bairro1->_nome ?></td>
                                        <td><?php echo $dadosZona->_nome ?></td>
                                        <td><?php echo $dadosTerreno->_quateirao ?></td>
                                        <td><?php echo $dadosTerreno->_bloco ?></td>
                                        <td><?php echo $dadosTerreno->_area ?> m<sup>2</sup></td>
                                    </tr>
                                    </tbody>
                                </table>
                            </fieldset>
                            ...
                            <div class="btn-group pull-right" data-toggle="buttons">
                                <a href="#modal-parecer-admin"
                                   class="btn btn-xs btn-default" data-toggle="modal">Ver o parecer</a>&nbsp;<a
                                    ...
                                    data-toggle="modal">Adicionar Parecer</a>
                            </div>
                            <h4 class="panel-title"><i class="fa fa-user"></i> <?php echo stripslashes($utente->_nome) ?></h4>
                        </div>
                        <div class="panel-body p-t-0">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h6 class="modal-title">Parecer do Técnico</h6>
            </div>
