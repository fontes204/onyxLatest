                        ...
                        <div class="profile-info">
                                ...
                                <form action="#" method="post" class="frm-verifcar-senha">
                                    <fieldset>
                                        ...
                                        <div class="form-group">
                                            <label for="exampleInputEmail1">Escolhe o Técnico</label>
                            ...
                            <div class="panel-footer m-b-25">
                                <div class="pull-right f-s-14">
                                    <a href="<?php echo URL?>processo/movimento" id_proc="<?php echo base64_decode($opcao[0]->getParam())?>" meu_id="<?php echo $_SESSION['id_user']?>" class="btn btn-sm btn-primary btn-viar-tecnico">Enviar</a>
                                </div>
                            </div>
                            </form>
                        </div>
