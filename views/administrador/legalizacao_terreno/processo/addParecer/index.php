...
<!--                            <p>-->
<!--                                --><?php //if ($ctrlfase==0) { ?>
<!--                                    <a href="--><?php //echo URL.$att->getController() ?><!--/addParecer"-->
                        ...
                        <div class="profile-info">
                            ...
                            <div class="panel-footer m-b-25">
                                <div class="pull-right f-s-14">
                                    <a href="<?php echo URL?>processo/movimento" id_proc="<?php echo base64_decode($opcao[0]->getParam())?>" meu_id="<?php echo Session::get('id_user')?>" class="btn btn-sm btn-primary btn-enviar-cga">Enviar</a>
                                </div>
                            </div>
                            </form>
                        </div>
