    ...
    $.widget("bootstrap.bwizard", {
        ...
        _createButtons: function () {
            ...
            if (!this.buttons) {
                ...
                if(backBtnText != ''){
                    this.backBtn =
                        $("<li class='previous'><a class='btn btn-inverse'>" +
                            backBtnText + "</a></li>")
                ...
                if(finishBtnText != ''){
                    this.finishBtnText =
                        $("<li class='next'><a class='btn btn-primary m-l-2'>" +
                            finishBtnText + "</a>")
                            .appendTo(this.buttons).bind({
                            'click': function () {
                                self.finish();
                ...
                if(nextBtnText != ''){
                    this.nextBtn =
                        $("<li class='next'><a class='btn btn-inverse'>" +
                            nextBtnText + "</a>")
                            .appendTo(this.buttons).bind({
                            'click': function () {
                                self.next();
                                var numVertice=$('.numVertice').val();
                                gerarVertices(numVertice);
                                return false;
                            }
                        }).attr("role", "button");
                    var requiresPager = true;
        ...
        finish:function () {
            registo();//funcao responsável por fazer todos os inserts em uma tabela, usando o plugin wizard
        },
